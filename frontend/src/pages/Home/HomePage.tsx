    ...
    <div className="min-h-screen bg-white">
      <section className="px-4 pt-16 pb-12 md:pt-24 md:pb-16">
        <div className="max-w-6xl mx-auto">
          <p className="inline-flex items-center rounded-lg border border-gray-200 bg-gray-50 px-3 py-1 text-xs font-semibold tracking-wide text-gray-600">
            PERFORMANCE ARCHIVE PLATFORM
          </p>
          <div className="mt-6 grid gap-10 lg:grid-cols-[1.2fr_0.8fr] lg:items-end">
            <div>
              ...
              <p className="mt-5 max-w-2xl text-base md:text-lg text-gray-600 leading-relaxed">
                최신 공연 탐색, 리뷰 확인, 개인 다이어리 기록과 통계 분석을
...
function FeatureRow({
  ...
  return (
    <div className="flex items-start gap-3 rounded-xl border border-gray-200 bg-white px-4 py-3">
      <span className="mt-0.5 inline-flex h-7 w-7 items-center justify-center rounded-md bg-gray-100 text-gray-700">
        {icon}
      </span>
      <div>
